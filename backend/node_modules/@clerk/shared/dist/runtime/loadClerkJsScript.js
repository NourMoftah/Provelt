...
const require_keys = require('./_chunks/keys-COv7Q4fb.js');
...
require('./_chunks/retry-ebkee0q8.js');
const require_loadScript = require('./_chunks/loadScript-B-liGNbh.js');
const require_proxy = require('./_chunks/proxy-CXA3-1VB.js');
require('./_chunks/instance-DPIKVAEY.js');
const require_url = require('./_chunks/url-Cq_6jGm6.js');
const require_versionSelector = require('./_chunks/versionSelector-BiQ3L7He.js');
...
const clerkUIScriptUrl = (opts) => {
	...
	const version = require_versionSelector.versionSelector(__internal_clerkUIVersion, "1.16.0");
